...
int main( int argc, char* argv[] ){
    ...
    PlotGen plotGen( results ); // second argument is defined as: enum Option { kDefault = 0, kNoGenMC }; enum automatically +1 for has no initializer
...
//            cout << "   looping over requested histograms" << endl;
            for (unsigned int ivar  = 0; ivar  < EtaPiPlotGenerator::kNumHists; ivar++){
                for (int ireact=0; ireact<(int)reactionList.size(); ++ireact){ // list of reactions: i.e. EtaPi0_000, EtaPi0_045...
                    ...
                    else if (ivar == EtaPiPlotGenerator::kEtaPiMass_25MeVBin)  histname += "Metapi_25MeVBin";
                    else if (ivar == EtaPiPlotGenerator::kEtaPiMass_10MeVBin)  histname += "Metapi_10MeVBin";
                    else if (ivar == EtaPiPlotGenerator::kEtaPiMass_5MeVBin)  histname += "Metapi_5MeVBin";
                    else if (ivar == EtaPiPlotGenerator::kEtaPiMass_2MeVBin)  histname += "Metapi_2MeVBin";
